...
check('一覧に本数と区分・組上がり・提出の列', panel.indexOf('論文の内訳（3本') >= 0 && panel.indexOf('<th>区分</th>') >= 0 && panel.indexOf('<th>組上がり</th>') >= 0 && panel.indexOf('<th>初校提出</th>') >= 0);
check('一覧の区分', panel.indexOf('<td>表回り</td><td>表紙</td>') >= 0 && panel.indexOf('<td>本文</td><td>論文A</td>') >= 0);
